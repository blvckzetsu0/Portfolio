...
const translations = {
  ...
  ar: {
    ...
    hello: "مرحباً، أنا",
    name: "عزمي زكرياء",
    title: "مهندس برمجيات المستقبل",
    
    // About section
    aboutTitle: "نبذة عني",
    aboutSubtitle: "مهندس برمجيات المستقبل",
    aboutText: "مرحباً! أنا عزمي زكرياء، طالب هندسة برمجيات لدي اهتمام واسع بالتكنولوجيا وتطوير البرمجيات. أستمتع باستكشاف مجالات مختلفة من البرمجة، من تطوير الويب والتصميم إلى حل المشكلات وأساسيات الأنظمة. أتعلم باستمرار وأجرب وأحسن مهاراتي لأنمو كمهندس متعدد المهارات.",
...
function updatePageText() {
  ...
  document.querySelector('.home .container-text h3').innerHTML = t.title.replace('Software', '<span>Software</span>');
  
  // About section
  document.querySelector('.about .container-text h1').innerHTML = t.aboutTitle.replace('Me', '<span>Me</span>').replace('Moi', '<span>Moi</span>').replace('عني', '<span>عني</span>');
  document.querySelector('.about .container-text h5').innerHTML = t.aboutSubtitle.replace('Software', '<span>Software</span>').replace('Logiciel', '<span>Logiciel</span>').replace('برمجيات', '<span>برمجيات</span>');
  document.querySelector('.about .container-text p').textContent = t.aboutText;
  
  // Skills section
  document.querySelector('.skills .container-text h1').innerHTML = t.skillsTitle.replace('Skills', '<span>Skills</span>').replace('Compétences', '<span>Compétences</span>').replace('مهاراتي', '<span>مهاراتي</span>');
